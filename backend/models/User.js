...
const UserSchema = new mongoose.Schema(
  {
    ...
    // In models/User.js (MongoDB Schema)
    // ...
    accountStatus: {
      type: String,
      enum: ["active", "suspended", "pending_review"], // pending_review could be initial state
      default: "pending_review", // Or 'active' if new users are active by default
    },
    // ...
    clerkCreatedAt: { type: Date },
  },
  { timestamps: true }
); // Adds createdAt and updatedAt for our DB records
